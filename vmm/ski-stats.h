...
#define SKI_STATS_MAX_DATA_ADDRESSES 3*1000*1000
#define SKI_STATS_MAX_ACCESS_SIZE 9
#define SKI_STATS_MAX_DATA_INSTRUCTION_ADDRESSES 3*1000*1000
...
static inline void ski_stats_add_instruction_access(int eip_address);
