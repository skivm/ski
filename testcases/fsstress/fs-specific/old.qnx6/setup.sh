...
echo "Executing the setup specific to XXX"

# XXX: Install/download packages to mkfs (dpkg -i ... or apt-get install)
...
mkfs.XXX ${LOOP_DEVICE}

mkdir $MOUNT_DIR
mount -t XXX ${LOOP_DEVICE} $MOUNT_DIR
mount
